    ...
    <div className=' py-8 container'>
      <div className=' mx-auto px-4 sm:px-6 lg:px-8 bg-white py-6 rounded-xl'>
        <div className='flex flex-col md:flex-row -mx-4'>
            ...
            <div className=' grid grid-cols-4 gap-4'>
              <div className='col-span-1'>
                <div className='flex items-center justify-center flex-col gap-4'>
                  <img
                    className='w-full h-[181px] object-cover rounded-2xl'
              ...
              <div className='col-span-3'>
                <img
                  className='w-full h-[581px] object-cover rounded-2xl '
                  src='/assets/product/product2.png'
                  alt='Product'
                />
              </div>
          ...
          <div className='md:flex-1 px-4'>
            <h2 className='text-4xl  font-mont text-gray-800 mb-4'>
              Men’s Artificial leather Jacket
            </h2>
            <p className='text-gray-600 text-sm mb-4 font-mont'>
              Feel every moment of your workflow with precision, visualization,
              and performance
            </p>
            ...
            <div className='mb-6'>
              ...
              <div className='flex items-center mt-4 '>
                {['S', 'M', 'L', 'XL', 'XXL'].map((size) => (
                  <button
                    key={size}
                    className=' text-gray-400 border-2 py-2 px-5 rounded-full  mr-2 hover:bg-gray-100'
                  >
                    {size}
                  </button>
                ))}
            ...
            <div className='mb-6'>
              ...
              <div className='flex items-center gap-3 mt-4'>
                <div className='border-2 flex items-center justify-center rounded-full p-1'>
                  <button className='w-[40px] h-[40px]    rounded-full bg-gray-800 '></button>
                </div>
                <div className='border-2 flex items-center justify-center rounded-full p-1'>
                  <button className='w-[40px] h-[40px]    rounded-full bg-orange-500 '></button>
                </div>
                <div className='border-2 flex items-center justify-center rounded-full p-1'>
                  <button className='w-[40px] h-[40px]    rounded-full bg-gray-300 '></button>
                </div>
              </div>
            </div>
            <div className='flex items-center justify-start gap-4 text-md mb-6'>
              <div className='flex items-center justify-between gap-2 text-blue-600  bg-gray-200 px-3 py-2 rounded-md'>
                <CiShop className='text-2xl ' />
                <span>Adidas</span>
              </div>
              <div className='w-[2px] h-3 bg-gray-400'></div>

              <div className='flex items-center justify-between gap-2 font-mont font-medium'>
                <FaRegStarHalfStroke className='text-yellow-500' />
                <span>45 Reviews</span>
              </div>
              <div className='w-[2px] h-3 bg-gray-400'></div>

              <div className='flex items-center justify-between gap-2 bg-gray-200 px-3 py-1 rounded-md'>
                <span>482 </span>
                <span>Sold</span>
              </div>
            </div>
            ...
            <div className='flex items-center justify-start gap-2 text-md mb-6'>
              <span className='text-accent font-bold text-2xl'>$385.00</span>
