      ...
      <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3 '>
          ...
          <div className='grid grid-cols-1  gap-5 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3'>
            <div>
              <p className='font-medium text-gray-300'>Top Links</p>
            ...
            <div>
              <p className='font-medium text-gray-300'>Our Company</p>
        ...
        <div className='flex items-center justify-between border-t border-gray-600'>
